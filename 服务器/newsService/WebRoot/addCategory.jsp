...
<div class="admin">
	<form action="<%=basePath %>servlet/AddCategoryServlet" method="post" >
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>修改信息</strong></div>
        <table class="table table-hover">
        	<tr><th width="120">频道</th><td><input type="text" name="title" /></td></tr>
        	<tr><th width="100">操作</th>
        		<td>
            		<button type="submit" class="button border-blue button-little" onclick="{if(confirm('修改成功！')){window.href='getAllStuInfoAction' return true;}return false;}">修改</button> 
